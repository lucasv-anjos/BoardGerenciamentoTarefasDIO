...
import static DIO.Projetos.ListaTarefa.persistence.converter.OffsetDateTimeConverter.toOffsetDateTime;
...
public class CardDAO {
    ...
    public CardEntity insert(final CardEntity entity) throws SQLException{
        var sql = "INSER INTO CARDS (title , description, board_column_id) VALUES (? , ? , ?);";
